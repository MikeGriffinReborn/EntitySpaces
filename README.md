...
1. Install [EntitySpaces Studio](https://github.com/MikeGriffinReborn/EntitySpaces_DotNetStandard/raw/master/EntitySpaces.Studio/EntitySpacesstudio_2019.0.0731.zip/ "Zip File")
...
EntitySpaces will serialize hierarchical data and if your query brings back extra columns via a JOIN or creating an extra column such as we do with "fullName" in the example below it will be present in the JSON even though you don't have a property on your Entity for it. 
